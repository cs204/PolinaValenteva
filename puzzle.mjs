...
знания2.добавить(new Эквивалентность(new И(АРыцарь, БРыцарь), БЛжец))
    // Добавьте
...
знания3.добавить(new Эквивалентность(new И(АРыцарь, БЛжец), ВРыцарь))
знания3.добавить(new Импликация(АЛжец, АРыцарь))
